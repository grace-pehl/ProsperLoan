...
c(cor(as.numeric(fulldf$CreditScore), as.numeric(fulldf$Rating)), 
  cor(fulldf$CreditScore, fulldf$ProsperScore), 
  cor(fulldf$CreditScore, as.numeric(fulldf$CreditGrade)))
```
...
plot3a <- ggplot(data = filter(fulldf, Rating != "NA") %>% droplevels(), 
          ...
          theme(axis.ticks = element_blank(), axis.text.x = element_blank(),
                axis.title.x = element_blank()) +
          ylab("Percentage of Origination Dollars") +
