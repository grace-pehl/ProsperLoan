...
This plot is just based on the total original loan amount and does not reflect any payments the borrower made before going into default.

```{r}
ggLoss <- ggplot(data = arrange(fulldf, Results), 
                 aes(x = Rating, 
